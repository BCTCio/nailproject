...
FormID: jqueryform-0eab6d
Date: 2022-11-16 12:49:26
...
<head>
  ...
  <header class="ann-site-header">
      <div class="container">
          <div class="row align-items-center" style="text-align:center; padding-top:50px;">
              <!-- Logo -->
              <div class="col-md-9 ann-site-logo-wrap">
                  <a href="../index.html" class="ann-site-logo"><img src="../img/logo-white.png" alt="ANN"></a>
              </div>
              <!-- Menu Burger -->
...
.form-control{
  border-bottom: 1px solid #C76663;
  border-left: none;
  border-right: none;
  border-top: none;
  border-radius:0;
...
<form data-licenseKey="" name="jqueryform-a69e88" id="jqueryform-a69e88" action='admin.php' method='post' enctype='multipart/form-data' novalidate autocomplete="on">
...
<div class="form-group f7 required" data-fid="f7">
  <label class="control-label" for="f7">First Name</label>
...
<div class="form-group f8 required" data-fid="f8">
  <label class="control-label" for="f8">Last Name</label>
...
<div class="form-group f9 required" data-fid="f9">
  <label class="control-label" for="f9">Email</label>


<input type="email" class="form-control" id="f9" name="f9" value=""   
...
<div class="form-group f18 required" data-fid="f18">
  <label class="control-label" for="f18">Phone</label>

<div class="input-group"><span class="input-group-addon left"><i class="glyphicon glyphicon-earphone"></i> </span>
<input type="tel" class="form-control" id="f18" name="f18" value=""   placeholder="xxx-xxx-xxxx" 
...
<div class="form-group f10 required inline" data-fid="f10">
  <label class="control-label" for="f10">Select Services</label>

<div class="checkbox">
  	<input  id="f10_1" name="f10[]"  type="checkbox" value="Manicure" 
    data-rule-required="true"  >
  	<label  for="f10_1">
  		Manicure
  	</label>
  ...
  <div class="checkbox">
  	<input  id="f10_2" name="f10[]"  type="checkbox" value="Pedicure"  >
  	<label  for="f10_2">
  		Pedicure
  	</label>
  </div>
  ...
  <div class="checkbox">
  	<input  id="f10_3" name="f10[]"  type="checkbox" value="Spa Pedicure"  >
  	<label  for="f10_3">
  		Spa Pedicure
  	</label>
  </div>
  ...
  <div class="checkbox">
  	<input  id="f10_4" name="f10[]"  type="checkbox" value="Waxing"  >
  	<label  for="f10_4">
  		Waxing
  	</label>
  </div>
  ...
  <div class="checkbox">
  	<input  id="f10_5" name="f10[]"  type="checkbox" value="Massage"  >
  	<label  for="f10_5">
  		Massage
  	</label>
  </div>
...
<div class="form-group f11 " data-fid="f11">
  <label class="control-label" for="f11">Open Hours</label>

	<div class="mainDescription">
		<p>Mon-Sat: 10:00am-8:00pm Sunday: 10:00am-7:00pm</p>
	</div>
...
<div class="form-group f12 required" data-fid="f12">
  <label class="control-label" for="f12">Appointment Date</label>

<div class="input-group date">
<input type="text" class="form-control datepicker" id="f12" name="f12" value=""   
    data-rule-required="true"   />
...
<div class="form-group f14 required" data-fid="f14">
  <label class="control-label" for="f14">Appintment Time</label>


<input type="text" class="form-control" id="f14" name="f14" value=""    
    data-rule-required="true"  />
...
<div class="form-group f15 required" data-fid="f15">
  <label class="control-label" for="f15">Numbers of Guests</label>
...
<div class="form-group f17 " data-fid="f17">
  <label class="control-label" for="f17">Message</label>
...
<div class="container jf-thankyou" style="display:none;" data-redirect="" data-seconds="10">
  <h3>Please note that your appointment will only be confirmed if you received a text from us. If you didn’t received or hear from us that mean the time slot you chose isn’t available. Please call us before going in. Thank you!</h3>
</div>
<!-- ----------------------------------------------- -->
...
<script src="jqueryform.com.min.js?ver=v2023.2.15&id=jqueryform-a69e88" ></script>
...
var checkers = '.icheckbox_flat-red, .iradio_flat-red';
