#!/usr/bin/perl
# AWSTATS FOR WINDOWS VERSION V.2.0
#------------------------------------------------------------------------------
...
(2,2,0,2,2,2,2,2,2);
use vars qw/
$DirLock $DirCgi $DirConfig $DirData $WinData $DirIcons $DirLang $AWScript $ArchiveFileName
...
sub Read_Config {
	...
	# New Boston Windows pacakge (8/08):            awstats.conf located in each users stats directory
	my $configdir=shift;
...
sub Read_Ref_Data {
	...
	# New Boston Windows pacakge (8/08):		"\\\\frigga\\home\\EXEs\\awstats-6.7\\wwwroot\\cgi-bin\\" CIFS PATH
	my @PossibleLibDir=("\\\\frigga\\home\\EXEs\\awstats-6.7\\wwwroot\\cgi-bin\\lib");
...
sub Read_Language_Data {
	...
	# New Boston Windows pacakge (8/08):            "\\\\frigga\\home\\EXEs\\awstats-6.7\\wwwroot\\cgi-bin\\" CIFS PATH
	my @PossibleLangDir=("\\\\frigga\\home\\EXEs\\awstats-6.7\\wwwroot\\cgi-bin\\lang");
...
sub Check_Config {
	...
	$LogSeparator||="\\s";
        ...
        # New Boston Windows update - use WinDir for CIFS path, instead of unix
        $DirData = $WinData || $DirData || '.';
...
sub Read_Plugins {
	...
	# New Boston Windows pacakge (8/08):            "\\\\frigga\\home\\EXEs\\awstats-6.7\\wwwroot\\cgi-bin\\" CIFS PATH
	my @PossiblePluginsDir=("\\\\frigga\\home\\EXEs\\awstats-6.7\\wwwroot\\cgi-bin\\plugins");
 	my %DirAddedInINC=();
